...
public final class WebSocketServer {
    ...
    private void init() throws Exception {
        ...
        try {
            ...
            System.out.println("Open your web browser and navigate to " +
                    (SSL ? "https" : "http") + "://127.0.0.1:" + webSocketConfig.getPort() + '/');
    ...
    public void addListener(ChannelStatusListener channelStatusListener) {
        channelStatusManager.addListener(channelStatusListener);
    }

    public void removeListener(ChannelStatusListener channelStatusListener) {
        channelStatusManager.removeListener(channelStatusListener);
    }
}
